...
async def on_message(message):
    global data, prefix, client, base, tutorial, api, foo, lastMessage
    ...
    if message.content[0] == prefix or client.user in message.mentions or message.channel.is_private:
        ...
        if content.startswith("api "):
            ...
            lastMessage = await client.edit_message(msg, new_content="", embed=discord.Embed(title=title, description=tdif, color=discord.Color(randint(0, 16777215))))
